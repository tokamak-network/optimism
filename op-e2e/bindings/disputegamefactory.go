...
// Rat is a free data retrieval call binding the contract method 0xf5a7ab6e.
//
// Solidity: function rat() view returns(address)
func (_DisputeGameFactory *DisputeGameFactoryCaller) Rat(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _DisputeGameFactory.contract.Call(opts, &out, "rat")
...
//
// Solidity: function rat() view returns(address)
func (_DisputeGameFactory *DisputeGameFactorySession) Rat() (common.Address, error) {
	return _DisputeGameFactory.Contract.Rat(&_DisputeGameFactory.CallOpts)
}

// Rat is a free data retrieval call binding the contract method 0xf5a7ab6e.
//
// Solidity: function rat() view returns(address)
func (_DisputeGameFactory *DisputeGameFactoryCallerSession) Rat() (common.Address, error) {
	return _DisputeGameFactory.Contract.Rat(&_DisputeGameFactory.CallOpts)
}
...
// SetRAT is a paid mutator transaction binding the contract method 0x21aec12e.
//
// Solidity: function setRAT(address _rat) returns()
func (_DisputeGameFactory *DisputeGameFactoryTransactor) SetRAT(opts *bind.TransactOpts, _rat common.Address) (*types.Transaction, error) {
	return _DisputeGameFactory.contract.Transact(opts, "setRAT", _rat)
}

// SetRAT is a paid mutator transaction binding the contract method 0x21aec12e.
//
// Solidity: function setRAT(address _rat) returns()
func (_DisputeGameFactory *DisputeGameFactorySession) SetRAT(_rat common.Address) (*types.Transaction, error) {
	return _DisputeGameFactory.Contract.SetRAT(&_DisputeGameFactory.TransactOpts, _rat)
}

// SetRAT is a paid mutator transaction binding the contract method 0x21aec12e.
//
// Solidity: function setRAT(address _rat) returns()
func (_DisputeGameFactory *DisputeGameFactoryTransactorSession) SetRAT(_rat common.Address) (*types.Transaction, error) {
	return _DisputeGameFactory.Contract.SetRAT(&_DisputeGameFactory.TransactOpts, _rat)
}
