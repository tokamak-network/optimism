...
//
// Solidity: function attentionTests(address ) view returns(bytes32 outputRoot, uint96 bondAmount, address challengerAddress, uint64 l1BlockNumber, bool evidenceSubmitted)
...
//
// Solidity: function initialize(address _disputeGameFactory, uint256 _perTestBondAmount, uint256 _evidenceSubmissionPeriod, uint256 _minimumStakingBalance, uint256 _ratTriggerProbability, address _ratManager) payable returns()
func (_RAT *RATTransactor) Initialize(opts *bind.TransactOpts, _disputeGameFactory common.Address, _perTestBondAmount *big.Int, _evidenceSubmissionPeriod *big.Int, _minimumStakingBalance *big.Int, _ratTriggerProbability *big.Int, _ratManager common.Address) (*types.Transaction, error) {
	return _RAT.contract.Transact(opts, "initialize", _disputeGameFactory, _perTestBondAmount, _evidenceSubmissionPeriod, _minimumStakingBalance, _ratTriggerProbability, _ratManager)
}

// Initialize is a paid mutator transaction binding the contract method 0x5df5f96f.
//
// Solidity: function initialize(address _disputeGameFactory, uint256 _perTestBondAmount, uint256 _evidenceSubmissionPeriod, uint256 _minimumStakingBalance, uint256 _ratTriggerProbability, address _ratManager) payable returns()
func (_RAT *RATSession) Initialize(_disputeGameFactory common.Address, _perTestBondAmount *big.Int, _evidenceSubmissionPeriod *big.Int, _minimumStakingBalance *big.Int, _ratTriggerProbability *big.Int, _ratManager common.Address) (*types.Transaction, error) {
	return _RAT.Contract.Initialize(&_RAT.TransactOpts, _disputeGameFactory, _perTestBondAmount, _evidenceSubmissionPeriod, _minimumStakingBalance, _ratTriggerProbability, _ratManager)
}

// Initialize is a paid mutator transaction binding the contract method 0x5df5f96f.
//
// Solidity: function initialize(address _disputeGameFactory, uint256 _perTestBondAmount, uint256 _evidenceSubmissionPeriod, uint256 _minimumStakingBalance, uint256 _ratTriggerProbability, address _ratManager) payable returns()
func (_RAT *RATTransactorSession) Initialize(_disputeGameFactory common.Address, _perTestBondAmount *big.Int, _evidenceSubmissionPeriod *big.Int, _minimumStakingBalance *big.Int, _ratTriggerProbability *big.Int, _ratManager common.Address) (*types.Transaction, error) {
	return _RAT.Contract.Initialize(&_RAT.TransactOpts, _disputeGameFactory, _perTestBondAmount, _evidenceSubmissionPeriod, _minimumStakingBalance, _ratTriggerProbability, _ratManager)
}
...
// SubmitCorrectEvidence is a paid mutator transaction binding the contract method 0x5ba97250.
//
// Solidity: function submitCorrectEvidence(address _gameAddress, bytes32 _version, bytes32[17] _stateTrieNode, bytes32 _messagePasserStorageRoot, bytes32 _latestBlockhash) returns()
func (_RAT *RATTransactor) SubmitCorrectEvidence(opts *bind.TransactOpts, _gameAddress common.Address, _version [32]byte, _stateTrieNode [17][32]byte, _messagePasserStorageRoot [32]byte, _latestBlockhash [32]byte) (*types.Transaction, error) {
	return _RAT.contract.Transact(opts, "submitCorrectEvidence", _gameAddress, _version, _stateTrieNode, _messagePasserStorageRoot, _latestBlockhash)
}

// SubmitCorrectEvidence is a paid mutator transaction binding the contract method 0x5ba97250.
//
// Solidity: function submitCorrectEvidence(address _gameAddress, bytes32 _version, bytes32[17] _stateTrieNode, bytes32 _messagePasserStorageRoot, bytes32 _latestBlockhash) returns()
func (_RAT *RATSession) SubmitCorrectEvidence(_gameAddress common.Address, _version [32]byte, _stateTrieNode [17][32]byte, _messagePasserStorageRoot [32]byte, _latestBlockhash [32]byte) (*types.Transaction, error) {
	return _RAT.Contract.SubmitCorrectEvidence(&_RAT.TransactOpts, _gameAddress, _version, _stateTrieNode, _messagePasserStorageRoot, _latestBlockhash)
}

// SubmitCorrectEvidence is a paid mutator transaction binding the contract method 0x5ba97250.
//
// Solidity: function submitCorrectEvidence(address _gameAddress, bytes32 _version, bytes32[17] _stateTrieNode, bytes32 _messagePasserStorageRoot, bytes32 _latestBlockhash) returns()
func (_RAT *RATTransactorSession) SubmitCorrectEvidence(_gameAddress common.Address, _version [32]byte, _stateTrieNode [17][32]byte, _messagePasserStorageRoot [32]byte, _latestBlockhash [32]byte) (*types.Transaction, error) {
	return _RAT.Contract.SubmitCorrectEvidence(&_RAT.TransactOpts, _gameAddress, _version, _stateTrieNode, _messagePasserStorageRoot, _latestBlockhash)
}

// TriggerAttentionTest is a paid mutator transaction binding the contract method 0x96e9b641.
//
// Solidity: function triggerAttentionTest(address _gameAddress, bytes32 _outputRoot, bytes32 _blockHash) returns()
func (_RAT *RATTransactor) TriggerAttentionTest(opts *bind.TransactOpts, _gameAddress common.Address, _outputRoot [32]byte, _blockHash [32]byte) (*types.Transaction, error) {
	return _RAT.contract.Transact(opts, "triggerAttentionTest", _gameAddress, _outputRoot, _blockHash)
}

// TriggerAttentionTest is a paid mutator transaction binding the contract method 0x96e9b641.
//
// Solidity: function triggerAttentionTest(address _gameAddress, bytes32 _outputRoot, bytes32 _blockHash) returns()
func (_RAT *RATSession) TriggerAttentionTest(_gameAddress common.Address, _outputRoot [32]byte, _blockHash [32]byte) (*types.Transaction, error) {
	return _RAT.Contract.TriggerAttentionTest(&_RAT.TransactOpts, _gameAddress, _outputRoot, _blockHash)
}

// TriggerAttentionTest is a paid mutator transaction binding the contract method 0x96e9b641.
//
// Solidity: function triggerAttentionTest(address _gameAddress, bytes32 _outputRoot, bytes32 _blockHash) returns()
func (_RAT *RATTransactorSession) TriggerAttentionTest(_gameAddress common.Address, _outputRoot [32]byte, _blockHash [32]byte) (*types.Transaction, error) {
	return _RAT.Contract.TriggerAttentionTest(&_RAT.TransactOpts, _gameAddress, _outputRoot, _blockHash)
}
...
// RATDebugRATIterator is returned from FilterDebugRAT and is used to iterate over the raw logs and unpacked data for DebugRAT events raised by the RAT contract.
type RATDebugRATIterator struct {
	Event *RATDebugRAT // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *RATDebugRATIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *RATDebugRATIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *RATDebugRATIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// RATDebugRAT represents a DebugRAT event raised by the RAT contract.
type RATDebugRAT struct {
	Msg string
	Val *big.Int
	Raw types.Log // Blockchain specific contextual infos
}

// FilterDebugRAT is a free log retrieval operation binding the contract event 0x82158e19f679cae02572f62e952ee4e9fea43894f24b38325851ae6fe8f43663.
//
// Solidity: event DebugRAT(string msg, uint256 val)
func (_RAT *RATFilterer) FilterDebugRAT(opts *bind.FilterOpts) (*RATDebugRATIterator, error) {

	logs, sub, err := _RAT.contract.FilterLogs(opts, "DebugRAT")
	if err != nil {
		return nil, err
	}
	return &RATDebugRATIterator{contract: _RAT.contract, event: "DebugRAT", logs: logs, sub: sub}, nil
}

// WatchDebugRAT is a free log subscription operation binding the contract event 0x82158e19f679cae02572f62e952ee4e9fea43894f24b38325851ae6fe8f43663.
//
// Solidity: event DebugRAT(string msg, uint256 val)
func (_RAT *RATFilterer) WatchDebugRAT(opts *bind.WatchOpts, sink chan<- *RATDebugRAT) (event.Subscription, error) {

	logs, sub, err := _RAT.contract.WatchLogs(opts, "DebugRAT")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(RATDebugRAT)
				if err := _RAT.contract.UnpackLog(event, "DebugRAT", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseDebugRAT is a log parse operation binding the contract event 0x82158e19f679cae02572f62e952ee4e9fea43894f24b38325851ae6fe8f43663.
//
// Solidity: event DebugRAT(string msg, uint256 val)
func (_RAT *RATFilterer) ParseDebugRAT(log types.Log) (*RATDebugRAT, error) {
	event := new(RATDebugRAT)
	if err := _RAT.contract.UnpackLog(event, "DebugRAT", log); err != nil {
		return nil, err
	}
